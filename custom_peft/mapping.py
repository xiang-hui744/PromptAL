...
from .peft_dspal_model import PeftLopaModel, PeftLopaModelForMaskedLM
...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING = {
    ...
    "LOPA_MASKED_LM": PeftLopaModelForMaskedLM,  # My custom model
    ...
    "IDPG_FEATURE_EXTRACTION": PeftIDPGModelForFeatureExtraction,
}
